...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.multihead_attn = self.MultiHeadedSelfAttention(model_dim, num_heads)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded = embedded + self.multihead_attn(self.layer_norm1(embedded))
        #   x = x + feed_forward(layer_norm_2(x))
        out = embedded + self.vanilla_nn(self.layer_norm2(embedded))
